...
-- infer() succeeds but derives 0 new triples because email triples are in named
-- graphs, not the default graph.
SELECT pg_ripple.infer('ngs_test_default_scope') = 0 AS zero_derived_when_scope_default;
RESET pg_ripple.rule_graph_scope;
