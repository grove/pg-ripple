...
pub use scan::{
    ...
    deduplicate_predicate, drop_graph, drop_prefix, find_triples, for_each_encoded_triple_batch,
    get_statement_by_sid, list_graphs, list_prefixes, prefix_registry_generation, register_prefix,
    statement_id_for_triple, total_triple_count, triple_count_in_graph, triples_for_object,
    triples_for_subject,
};
