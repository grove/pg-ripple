...
- **SCHEMA-NORM-01–06**: Six internal catalog tables replaced text/string PKs and FKs with surrogate `BIGINT` identifiers, eliminating string comparison in hot join paths:
