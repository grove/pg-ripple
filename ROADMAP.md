...
v0.80–v0.83    ─── Assessment 12 critical/high/medium/low remediation: SPARQL Update
       ...
       │
v0.83.1–v0.83.3 ── Assessment 13 remediation: HTTP companion version sync, docker-compose
               │   tag, SECURITY DEFINER audit, migration chain v0.80–v0.83 checkpoints,
               │   plan cache double-parse, nested OPTIONAL+EXISTS fix, registration.rs split,
               │   strict_dictionary decode, schema.rs/federation.rs module splits, CI module-
               │   size lint, correction tests, performance hot-path metrics, supply chain
               │   upgrades, observability (EXPLAIN post-opt, JSON logs, graceful shutdown),
