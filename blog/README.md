...
| [Incremental View Maintenance with pg_trickle](ivm-pg-trickle-integration.md) | SPARQL CONSTRUCT views maintained by pg_trickle's differential dataflow engine. Z-set delta propagation, chained views, and the benchmark showing 12ms IVM latency vs 8,400ms full-refresh triggers — all in the same PostgreSQL transaction. |
