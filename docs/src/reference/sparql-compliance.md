...
As of v0.31.0, pg_ripple passes ≥ 95% of the applicable W3C SPARQL 1.1 test suite. The remaining gaps are listed in the Known Limitations section at the bottom.
```
